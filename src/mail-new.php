...
//$admin_email = array('amntech@mail.ru', 'sale5@amntech.ru', 'polimer21@list.ru'); // первым поставь почту, на которую будет указывать ответ и т.п.
...
'From: '.adopt($project_name).' <no-reply@opros.amn-plazma.ru>' . PHP_EOL .  // Вот тут как раз мы и используем первый адрес
